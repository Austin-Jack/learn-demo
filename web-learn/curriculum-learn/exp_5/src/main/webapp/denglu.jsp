...
<%
    ...
    if (user != null) {      //当user!=null时说明用户登录过
        name=user.getName();
%>
...
<%}%>
<div class="login">
    <form action="development/IdeaProjects/learn-demo/web-learn/curriculum-learn/exp_5/webapp/treatDengLu.jsp" method="post" name="form1">
        <table>
