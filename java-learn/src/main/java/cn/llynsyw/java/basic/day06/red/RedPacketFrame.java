package cn.llynsyw.java.basic.day06.red;
...
public abstract class RedPacketFrame extends JFrame {
    ...
    private static final String DIR_PATH = "redPackage-resources/";
    ...
    private static JLabel input_bg_label = new JLabel(new ImageIcon(DIR_PATH + "01_input.jpg"));
    ...
    private static JLabel open_label = new JLabel(new ImageIcon(DIR_PATH + "02_open_2.gif"));
    private static JLabel open_bg_label = new JLabel(new ImageIcon(DIR_PATH + "02_open_1.jpg"));
    ...
    private static JLabel show_bg_label = new JLabel(new ImageIcon(DIR_PATH + "03_money_1.jpg"));
...
//        System.out.println("层次面板||" + layeredPane);
    ...
    private void initFrame() {
        // logo
        this.setIconImage(Toolkit.getDefaultToolkit().getImage(DIR_PATH + "logo.gif"));
